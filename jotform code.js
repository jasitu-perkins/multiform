  ...
  Colors: {
    ...
    rgbToHex: function () {
      ...
      for (var i = 0; i < arguments.length; i++) {
        ret.push(
          (arguments[i] < 16 ? "0" : "") + Math.round(arguments[i]).toString(16)
        );
      }
...
Protoplus.utils = {
  ...
  setUnselectable: function (target) {
    if (
      ...
      target.className == "form-section-closed"
    ) {
    ...
    switch (options.direction) {
      case "bottom":
        if (pos[1] + options.offset[1] >= vp.height + window.scrollY) {
          window.scrollTo(
            window.scrollX,
            pos[1] + options.offset[1] - vp.height
          );
        } else if (
          window.scrollY !== 0 &&
          pos[1] + options.offset[1] <= Math.abs(vp.height - window.scrollY)
        ) {
          window.scrollTo(
            window.scrollX,
            pos[1] + options.offset[1] - vp.height
      ...
      case "top":
        ...
        if (
          window.scrollY !== 0 &&
          pos[1] <= window.scrollY + options.offset[1]
        ) {
  ...
  run: function (element, event) {
    if (event.include(":")) {
      ...
      var evt;
      var disabled =
        element.hasClassName("form-dropdown") && element.disabled
          ? !!element.enable()
          : false;
      if (
  ...
  shift: function (element, options) {
    ...
    if (options.link == "ignore" && element.timer) {
      ...
      (options.link == "chain" || options.link == "queue") &&
      element.timer
    ) {
    ...
    for (var i in properties) {
      ...
      if (["scrollX", "scrollLeft", "scrollY", "scrollTop"].include(okey)) {
        ...
        ["background", "color", "borderColor", "backgroundColor"].include(okey)
      ) {
        if (oval == "transparent") {
        ...
        from =
          Element.getStyle(
            element,
            okey.replace("-webkit-", "").replace("-moz-", "")
          ) || "0px";
        unit =
          okey == "opacity"
            ? ""
      ...
      if (time >= end) {
        ...
        for (okey in properties) {
          ...
          if (["scrollX", "scrollLeft", "scrollY", "scrollTop"].include(okey)) {
            ...
            ["background", "color", "borderColor", "backgroundColor"].include(
              okey
            )
          ) {
...
Protoplus.ui = {
  ...
  setDraggable: function (element, options) {
    ...
    if (
      options.snap &&
      (typeof options.snap == "number" || typeof options.snap == "string")
    ) {
    ...
    if (options.constrainOffset) {
      if (options.constrainOffset.length == 4) {
        options.constrainTop = options.constrainTop
          ? options.constrainTop
          : options.constrainOffset[0];
        options.constrainRight = options.constrainRight
          ? options.constrainRight
          : options.constrainOffset[1];
        options.constrainBottom = options.constrainBottom
          ? options.constrainBottom
          : options.constrainOffset[2];
        options.constrainLeft = options.constrainLeft
    ...
    var drag = function (e) {
      ...
      top =
        options.constrainBottom !== false && top >= options.constrainBottom
          ? options.constrainBottom
          : top;
      top =
        options.constrainTop !== false && top <= options.constrainTop
          ? options.constrainTop
          : top;
      left =
        options.constrainRight !== false && left >= options.constrainRight
          ? options.constrainRight
          : left;
      left =
        options.constrainLeft !== false && left <= options.constrainLeft
          ? options.constrainLeft
          : left;
      ...
      if (options.onEnd(drag_element, handler, ev) !== false) {
        ...
        if (options.revert) {
          if (options.revert === true) {
            options.revert = { easing: "sineIn", duration: 0.5 };
          }
    ...
    if (options.handler) {
      if (typeof options.handler == "string") {
        handler = options.handler.startsWith(".")
          ? element.descendants().find(function (h) {
    ...
    handler.observe(mouseDown, function (e) {
      ...
      if (options.constrainParent) {
        if (
          $(element.parentNode).getStyle("position") == "relative" ||
          $(element.parentNode).getStyle("position") == "absolute"
        ) {
          voff = { top: 0, left: 0 };
        } else {
          voff = Prototype.Browser.IE
      ...
      if (
        ["relative", "absolute"].include(
          $(element.parentNode).getStyle("position")
        )
      ) {
        startX = element.getStyle("left")
          ? parseInt(element.getStyle("left"), 10)
          : element.offsetLeft;
        startY = element.getStyle("top")
          ? parseInt(element.getStyle("top"), 10)
          : element.offsetTop;
      } else {
      ...
      if (options.clone) {
        drag_element = options.changeClone(
  ...
  tooltip: function (element, text, options) {
    ...
    if ("Prototip" in window) {
      options = Object.extend({ delay: 0.01 }, options || {});
    ...
    element.hover(
      function (el, evt) {
        ...
        outer = new Element("div", { className: "pp_tooltip_" }).setStyle({
          opacity: options.opacity,
          position: "absolute",
          zIndex: options.zIndex,
        });
        if (options.className) {
          tooldiv = new Element("div", { className: options.className })
            .setStyle({
              position: "relative",
              top: "0px",
              left: "0px",
        ...
        if (options.shadow) {
          ...
          shadLeft = options.shadow.left
            ? parseInt(options.shadow.left, 10)
            : 4;
        ...
        var makeItAppear = function () {
          if (options.fixed) {
            var fixTop = options.fixed.top
              ? parseInt(options.fixed.top, 10)
              : element.getHeight();
            var fixLeft = options.fixed.left
              ? parseInt(options.fixed.left, 10)
              : element.getWidth() - 50;
  ...
  rating: function (element, options) {
    ...
    element.setStyle({ cursor: options.disabled ? "default" : "pointer" });
    ...
    var setStar = function (i) {
      ...
      if (
        isNewTheme &&
        element.querySelectorAll(".rated").length === i &&
        desc[i - 1]
      ) {
        desc[i - 1]
          .setStyle({ backgroundPosition: image.blank })
      ...
      desc.each(function (e, c) {
        ...
        if (i - 1 < c) {
          e.setStyle({ backgroundPosition: image.blank }).removeClassName(
            "rated"
          );
        } else {
          if (c < i) {
            e.setStyle({ backgroundPosition: image.clicked }).addClassName(
              "rated"
            );
          }
        }
  ...
  slider: function (element, options) {
    ...
    options = Object.extend(
      {
        ...
        value: 0,
        buttonBack:
          'url("../images/ball.png") no-repeat scroll 0px 0px transparent',
      },
      options || {}
    );
    if ("JotForm" in window && "url" in JotForm) {
      options.buttonBack =
        'url("' +
        JotForm.url +
        '/images/ball.png") no-repeat scroll 0px 0px transparent';
    }
    ...
    var endTD = new Element("td", { align: "center", width: 20 }).insert(
      options.maxValue
    );
    ...
    sliderOut
      .observe("keypress", sliderKeys)
      .observe(Event.mousewheel, sliderWheel);
  ...
  spinner: function (element, options) {
    ...
    arrowCont.insert(
      (downTD = new Element("div", {
        className: "form-spinner-button form-spinner-down",
      }).insert(
        (downArrow = new Element("img", {
    ...
    var spinnerTableWidth =
      (options && options.width >= 180 ? options.width : 180) + "px";
    ...
    var numberUP = function (e) {
      ...
      var elementValueDP =
        parseInt(element.value) === parseFloat(element.value)
          ? 0
          : (element.value + "").split(".")[1].length;
      var addAmountDP =
        parseFloat(options.addAmount) === parseInt(options.addAmount)
          ? 0
          : (options.addAmount + "").split(".")[1].length;
      var decimalPoints =
        elementValueDP > addAmountDP ? elementValueDP : addAmountDP;
      element.value = (
  ...
  miniLabel: function (element, label, options) {
    options = Object.extend(
      { position: "bottom", color: "#666", size: 9, text: "", nobr: false },
      options || {}
    );
    element.wrap("span");
...
var JotForm = {
  ...
  validationRegexes: {
    ...
    cyrillic:
      /^[Ð°Ð±Ð²Ð³Ð´ÐµÑ‘Ð¶Ð·Ð¸Ð¹ÐºÐ»Ð¼Ð½Ð¾Ð¿Ñ€ÑÑ‚ÑƒÑ„Ñ…Ñ†Ñ‡ÑˆÑ‰ÑŒÑ‹ÑŠÑÑŽÑÐÐ‘Ð’Ð“Ð”Ð•ÐÐ–Ð—Ð˜Ð™ÐšÐ›ÐœÐÐžÐŸÐ Ð¡Ð¢Ð£Ð¤Ð¥Ð¦Ð§Ð¨Ð©Ð¬Ð«ÐªÐ­Ð®Ð¯\s]*$/,
  },
  freeEmailAddresses: [
    "gmail.",
    "aim.com",
      ...
      if (JotForm.isEditMode()) {
        ...
        Promise.all(
          fields.map(function (field) {
            ...
            return JotCrypto.reEncrypt(
              privateKey,
              encryptionKey
            )(field.value).then(function (encVal) {
              return Promise.resolve({ field: field, encryptedValue: encVal });
            });
          })
        )
  ...
  init: function (callback) {
    var ready = function () {
        ...
        window.onpageshow = function (e) {
          if (e.persisted) {
            ...
            if (JotForm.browserIs.ios()) window.location.reload();
              ...
              $A(document.querySelectorAll(".qq-upload-success")).each(
      ...
      document.dispatchEvent(event);
      if (window.self !== window.top && JotForm.isPaymentSelected()) {
  ...
  injectEditor: function (data, url) {
    ...
    p.$jot.getJSON(
      ...
      { action: "getScreenEditorTemplate", compact: this.compact },
      function (res) {
        var iff =
        ...
        if ($this.compact) {
          p.$jot("#js-form-content").css({ float: "right" });
        }
        var ie = $this.ie();
        if (ie !== undefined && ie < 9) {
          editorFrame.attr(
          ...
          b.click(function () {
            p.$jot.getJSON(
              ...
              { action: "getImage", uniqID: $this.scuniq },
              function (res) {
                if (!res.success) {
                  if (
                    confirm(
  ...
  initMultipleUploads: function () {
    ...
    var isIosApp = JotForm.browserIs.ios() && !JotForm.browserIs.safari();
          ...
          : new qq.FileUploader({
              ...
              onDelete: function (folder, field, filename) {
                ...
                if ($("draftID")) {
                  ...
                  var uploadedFile = $(uploadedFileID);
                  var uplodedFileArray = uploadedFile
                    ? JSON.parse(uploadedFile.value)
                    : [];
                  if (uplodedFileArray.includes(filename)) {
                    const filteredUplodedFileArray = uplodedFileArray.filter(
                      function (item) {
            ...
            if (productItem.querySelector(".form-checkbox")) {
              ...
              if (
                ...
                $$(".form-product-input").forEach(function (item) {
                  if (
                    item.checked &&
                    item.getValue() !== productItem.getAttribute("pid")
                  ) {
                    item.checked = false;
                  }
                });
  ...
  setBirthDateEvents: function () {
    ...
    var birthdateElements = document.querySelectorAll(
    ...
    birthdateElements.forEach((birthdate) => {
      ...
      var birthdateYear = birthdate.querySelector(
        '[data-component="birthdate-year"]'
      );
      var birthdateDay = birthdate.querySelector(
  ...
  setDateTimeFieldItem: function (fieldItem, qid) {
    ...
    if ($(fieldItem.key + "_" + qid)) {
      ...
      (JotForm.newDefaultTheme ||
        ...
        timeInputElement.dataset.version === "v2")
    ) {
  ...
  handleAutoCompletes: function () {
    ...
    $H(JotForm.autoCompletes).each(function (pair) {
      ...
      var selectCount = 0;
      var liHeight = 0;
      var list = new Element("div", { className: "form-autocomplete-list" })
        .setStyle({
          listStyle: "none",
      ...
      var render = function () {
        ...
        if (isCardForm) {
          ...
          list.setStyle({ top: top, left: left, width: width });
          list.show();
        } else {
  ...
  prePopulations: function (fields, isPrefill) {
    ...
    $H(_data).each(function (pair) {
      ...
      if (input && input.readAttribute("data-type") == "input-grading") {
        ...
        var isHtmlValue = /<([a-z][a-z0-9]*)\b[^>]*>(.*?)<\/\1>/i.test(
          pair.value
        );
        ...
        if (isHtmlValue) {
          ...
          input
            .up("div")
            .down(".nicEdit-main")
            .update(val.replace(/</g, "&lt;").replace(/>/g, "&gt;"));
        }
      } else if (
        input &&
        input.hasClassName("form-textarea") &&
      ...
      JotForm.onTranslationsFetch(function () {
        ...
        $$(checkboxParam).each(function (input) {
          ...
          var valueSplittedByComma = value
            .replace(/([^\\]),/g, "$1\u000B")
            .split("\u000B");
          allTranslations.each(function (inputValue) {
            ...
            if (
              ...
              valueSplittedByComma.includes(replaceUnicodeSpaces(inputValue))
            ) {
              if (!input.checked) {
                if (input.disabled) {
                  input.enable();
  ...
  showField: function (field, isConditionActive) {
    ...
    if (
      element.getAttribute("data-type") === "control_button" &&
      ...
      element.getElementsBySelector("button").each(function (item) {
        if (
          ...
          item.hasClassName("useJotformSign-button")
        ) {
          item.show();
        } else if (
          (!JotForm.useJotformSign || JotForm.useJotformSign !== "Yes") &&
          item.hasClassName("submit-button")
        ) {
          item.show();
        }
        if (
          item.hasClassName("form-submit-reset") ||
          item.hasClassName("form-submit-print")
        ) {
          item.show();
        }
  ...
  hideField: function (field, multiple, dontClear) {
    ...
    if (element) {
      ...
      var isProductListInEditMode =
        ...
        element.getAttribute("data-type") === "control_payment";
      if (
        JotForm.paymentFields.indexOf(element.getAttribute("data-type")) > -1 &&
        !$("hiddenPaymentField") &&
      ...
      if (
        ...
        var saclButton = submitButtonsElements.find(function (bt) {
          return bt.hasClassName("form-sacl-button");
        });
        var previewPDFButton = submitButtonsElements.find(function (bt) {
      ...
      if (
        JotForm.clearFieldOnHide == "enable" &&
        JotForm.getInputType(field) === "signature"
      ) {
      ...
      if (type == "checkbox" || type == "radio") {
        ...
        $("id_" + field)
          ...
          .each(function (input) {
            ...
            if (!dataChanged && currentValue !== input.checked)
              dataChanged = true;
          });
        if ($("id_" + field).triggerEvent && !dontTrigger && dataChanged)
          $("id_" + field).triggerEvent("change");
      } else if (type == "select") {
        if ($("input_" + field)) {
          $("input_" + field).value = defaultValue;
  ...
  getMatrixValues: function (questionID, operator) {
    ...
    var checkedValues = function (value) {
      ...
      var yesNoValueText =
        Array.isArray(yesNoValue) && yesNoValue.length > 0
          ? yesNoValue[0].innerText
          : value.checked;
  ...
  checkCondition: function (condition, sourceField, sourceEvent) {
    ...
    if (conditionInfiniteLoop()) {
      if (JotForm.isConditionDebugMode) {
        console.log(
          { condition: condition, sourceField: sourceField },
          "IN CHECK CONDITION"
        );
      }
      return;
            ...
            if (
              ...
              try {
                ...
                if (
                  ...
                  var defaultValue =
                    "input_" + toBeClearField in JotForm.defaultValues
                      ? JotForm.defaultValues["input_" + toBeClearField]
                      : "";
      ...
      if (
        ...
        if (window.FORM_MODE == "cardform") {
          ...
          if (
            ...
            Array.from(
              document.querySelectorAll(".form-all .page-section")[pageId - 1]
                .children || []
            ...
            if (
              ...
              if (card.readAttribute("data-type") === "control_widget") {
                var inputSettings = card
                  .select(
                    'input[id="widget_settings_' + allQuestions[i].id + '"]'
                  )
                  .first();
                if (inputSettings && inputSettings.value) {
                  ...
                  for (var j = 0; j < settingsData.length; j++) {
                    if (
                      settingsData[j].name === "hide" &&
                      settingsData[j].value === "Yes"
                    ) {
                      hideWidget = true;
                      break;
                    }
  ...
  setFieldConditions: function (field, event, condition) {
    ...
    if (!JotForm.fieldConditions[tempField]) {
      JotForm.fieldConditions[tempField] = { event: event, conditions: [] };
    }
  ...
  enableDisableField: function (qid, enable) {
    ...
    try {
      ...
      var canEnabledDisabledWidget = isWidget
        ? $("id_" + qid).down("iframe")
        : false;
      var elements = [];
      if (subfieldID) {
  ...
  checkCalculation: function (calc, sourceField, sourceEvent) {
    ...
    var getValue = function (data, numeric) {
      ...
      switch (type) {
        ...
        case "inline":
          ...
          if (data.indexOf("|") > -1) {
            ...
            $$(selector).each(function (el) {
              if (
                !el.value.empty() &&
                ($("draftID") || JotForm.isVisible(el)) &&
                (!(
                  ["checkbox", "radio"].indexOf(el.getAttribute("type")) > -1
                ) ||
                  el.checked)
              ) {
                valArr.push(el.value);
              ...
              if (
                ...
                el.parentNode.parentNode.getAttribute("data-type") === "timebox"
              )
                isTime = true;
            });
            val = valArr.join(" ");
          ...
          if (
            ...
            if (fileList.length > 0) {
              val = fileList.reduce(function (acc, elem) {
                return (
                  (acc ? acc + ", " : "") + elem.getAttribute("actual-filename")
                );
              }, "");
            }
          } else {
        ...
        case "appointment":
          ...
          if (!!selection.length) {
            val =
              JotForm.calculationType(result) === "datetime"
    ...
    if (
      JotForm.ignoreInsertionCondition &&
      JotForm.replaceTagTest &&
      resultFieldType !== "html" &&
      resultFieldType !== "inline"
    ) {
      return;
    }
        ...
        for (var inputId in combinedObject) {
          if (inputId !== "") {
            if (
              ...
              if (
                calc.baseField &&
                $("id_" + calc.baseField).readAttribute("data-type") ===
                  "control_fullname"
              ) {
                $("id_" + result)
                  .select(
                  ...
                  .each(function (value) {
                    if (
                      value.readAttribute("data-component") == "cc_firstName"
                    ) {
                      fieldInputElement = value;
                    }
                    if (
                      value.readAttribute("data-component") == "cc_lastName"
                    ) {
                      fieldInputElement = value;
                    }
                  });
              ...
              for (var inputId in combinedObject) {
                if (JotForm.isTimeObject(inputId)) {
                  ...
                  if (inputId === "duration-ampmRange") {
                    ...
                    var durationAmpmRangeQuery = $("id_" + result).select(
                      "input[id*=" +
    ...
    var calculationInfiniteLoop = function () {
      ...
      var secPart = parseInt(timestamp / 1000);
      var antiLoopKey =
        (calc.id || calc.resultField) + "-" + secPart + "-" + msPart;
      var maxLoopSize = 19;
    ...
    if (infiniteLoop() || calculationInfiniteLoop()) {
      if (JotForm.isConditionDebugMode) {
        console.log(
          { calc: calc, sourceField: sourceField },
  ...
  getChecklistWidgetValues: function (data) {
    ...
    var checklistValue = itemLines.reduce(
  ...
  updateDonationAmount: function (amount) {
    if (
      !JotForm.donationSourceField ||
      JotForm.donationField.up(".form-line.form-field-hidden") ||
  ...
  paymentDropdownHandler: function (uid, onChange) {
    ...
    var productCategoryDropdown = document.querySelector(
      ...
      option.observe("click", function (event) {
        ...
        $A(options).each(function (opt) {
          if ($(opt).readAttribute("data-value") === optionVal) {
            selectedOption = { label: opt.innerText.trim(), value: optionVal };
          }
        });
  ...
  handleProductCategoryDropdown: function () {
    this.multiSelectDropdownHandler(function (
      ...
      var productSortingProductsDropdown = document.querySelector(
    ...
    if (window.location.href.indexOf("jotform_pwa=1") > -1) {
      ...
      hiddenInputs.each(function (inp) {
        if (inp.val || document.get[inp.name]) {
          form.insert(
            new Element("input", { type: "hidden", name: inp.name }).putValue(
  ...
  setCustomPriceSource: function (pairKey) {
    if (pairKey) {
      var customFirstPaymentPriceData = $(
        pairKey + "_custom_first_payment_price"
      );
      ...
      if (
        ...
        if (customPriceSourceKey) {
          var customPriceSourceInput = document.getElementById(
  ...
  countTotal: function (prices) {
    ...
    $H(prices).each(function (pair) {
      ...
      if (pair.value.price == "custom") {
        ...
        pair.value.customFirstPaymentPrice === "1"
      ) {
        JotForm.setCustomPriceSource(pair.key);
        if (
          $(pair.key) &&
        ...
        if (!discount[2]) {
          ...
          if (discount[2] === "all" || discount[2] === "product") {
            ...
            if (isSetupFee) {
              ...
              if (
                pair.value.firstPaymentVal &&
                pair.value.customFirstPaymentPrice === "0"
              ) {
                firstPaymentDiscount = reduced;
              }
      ...
      if (window.paymentType === "subscription") {
        function getDiscountedVal(val, firstOrAll) {
          if (rate && type && discount[2]) {
            ...
            } else if (firstOrAll === "first") {
              firstPaymentDiscount = reduce;
            }
            return parseFloat(val) > parseFloat(reduce)
        ...
        if (
          ...
          rate &&
          type &&
          (discount[2] === "all" || discount[2] === "stripe_native")
        ) {
          recurringVal = getDiscountedVal(recurringVal, "all");
        }
        var recurPaymentContainer = document.querySelector(
          ".form-payment-recurringpayments"
        );
        if (recurPaymentContainer && recurPaymentDiscount) {
          var discountHTML = recurPaymentContainer.innerHTML
            .replace(/Total|Total:/, "Discount:")
            .replace("payment_recurringpayments", "discount_recurringpayments")
            .replace("<span>", "<span> - ");
          ...
          $("discount_recurringpayments").update(
            parseFloat(recurPaymentDiscount).formatMoney(
              decimal,
              dSeparator,
              tSeparator
            )
      ...
      if ($(pair.value.quantityField)) {
        ...
        var quantityCorrectionForTextInput = function (qty) {
          ...
          qty.forEach(function (e) {
            var hasSubproductList = document.getElementsByClassName(
              "form-checkbox form-product-has-subproducts form-product-input"
            );
            var pairProductCheck =
              hasSubproductList[$(pair.key).id.slice(0, -2)];
        ...
        if (
          ...
          Object.keys(products).forEach(function (item) {
            if (!productConnectedProducts.includes(item)) {
              $$(
                '.form-product-item[pid="' + item + '"] .form-product-input'
              )[0].checked = false;
            }
          });
        }
      ...
      for (item in JotForm.pricesAfterCoupon) {
        ...
        if (connectedPids && connectedPids.length > 0) {
          ...
          connectedPids.forEach(function (pid) {
            ...
            var mainId = isSubproduct
              ? productId + "_" + subInputId
              : productId;
            if (action === "reset") {
              $(
  ...
  applyCoupon: function (discount) {
    ...
    var displayOldPrice = function (container, id) {
      ...
      var lineThroughStyle =
        window.FORM_MODE === "cardform" ? "" : "text-decoration:line-through;";
      var span = new Element("span", {
        style: lineThroughStyle + "display:inline-block;",
  ...
  highLightLines: function () {
    ...
    formLineList.forEach((formLine, index) => {
      const highLightableList = formLine.querySelectorAll(
      ...
      b.onclick = function () {
        ...
        setTimeout(function () {
          $$("input.form-widget").each(function (node) {
            node.value = "";
            node.fire("widget:clear", { qid: parseInt(node.id.split("_")[1]) });
          });
        }, 40);
        setTimeout(function () {
                ...
                document
                  ...
                  .forEach(function (tmpel) {
                    if (tmpel.attributes.unselectable.value == "on") {
                      var [toolbarEl, containerEl] = Array.from(
  ...
  initTextboxValidation: function () {
    $$(".form-textbox[data-minlength]").each(function (item) {
      item.validateTextboxMinsize = function () {
        ...
        if (
          (isRequired && item.value.length < min_val) ||
          (!isRequired && item.value !== "" && item.value.length < min_val)
        ) {
          return JotForm.errored(
            item,
          ...
          return JotForm.errored(
            item,
            JotForm.getValidMessage(JotForm.texts.maxCharactersError, max_val)
          );
        } else {
          var error = false;
  ...
  checkProductSelectionWithQuantity: function (productElement) {
    try {
      ...
      if (productElement.select("table").length > 0) {
        productElement
          .select(".form-subproduct-quantity")
          .each(function (quantityEl) {
    ...
    try {
      if (
        ...
        $$(".form-product-item").each(function (item) {
          ...
          if (
            productCheckbox !== undefined &&
            productCheckbox.hasAttribute("checked") &&
            productCheckbox.hasAttribute("disabled")
          ) {
            if (!JotForm.checkProductSelectionWithQuantity(item)) {
              JotForm.errored(
                paymentField,
                "The required product cannot be empty"
              );
              result = false;
              return false;
            } else {
      ...
      section.querySelectorAll(".form-pagebreak-next").forEach((el) => {
        el.addEventListener("click", () => {
          ...
          if (
            ...
            if (!JotForm.nextPage) {
              var sections = [
                ...document.querySelectorAll(".form-all > .page-section"),
              ];
              for (
            ...
            if (JotForm.nextPage) {
              ...
              JotForm.enableDisableButtonsInMultiForms();
            } else if (section.nextSiblings()[0]) {
              JotForm.backStack.push(JotForm.hideFormSection(section));
              JotForm.currentSection = JotForm.showFormSection(
  ...
  isInputAlwaysHidden: function (input) {
    ...
    var addressLineWrapper =
      input.up(".form-address-line-wrapper") || input.up(".form-address-line");
    ...
    if (
      JotForm.payment === "paypalpro" &&
      input.up("#creditCardTable") &&
      input.up("#creditCardTable").style.display === "none"
    ) {
      return true;
    }
    ...
    return (
      ...
      (cont.style && cont.style.display == "none") ||
      (cont.style && cont.style.visibility == "hidden")
    );
  },
  isSectionTouched: function (section) {
    ...
    if (JotForm.visitedPages[pagesIndex] && !JotForm.hidePages[pagesIndex])
      return true;
  },
  ...
  showFormSection: function (section, withoutFocus) {
    ...
    if (
      firstLabel &&
      !firstLabel.closest(".form-section-closed") &&
      !withoutFocus
    ) {
      ...
      if (inputElementID) {
        ...
        var isIosSelectBox =
          ...
          inputElement.classList.contains("form-dropdown");
  ...
  populateSignature: function (qid, value) {
    ...
    var signatureLine = signatureWrapper
      .first()
    ...
    if (value) {
      ...
      signatureLine
        ...
        .setValue(value);
      var sigimage =
        value && value.indexOf("data:image/png;") > -1
          ? value
          : "/" + value + "?nc=1";
  ...
  validateAll: function (form, scopeSelector) {
    function handleValidateAll(form, scopeSelector) {
      ...
      var allValidateClasses = $(scopeSelector).querySelectorAll(
        '*[class*="validate"]'
      );
        ...
        if (JotForm.payment && input.up(".form-line")) {
          ...
          if (dataType == "control_" + JotForm.payment) {
            ...
            if (
              ...
              !input.getAttribute("data-inputname").match("cc_") &&
              !isFirstProduct
            ) {
              return;
            }
      ...
      if (
        typeof window.ValidatePaymentGateways !== "undefined" &&
        !!document.querySelector(".form-pagebreak") &&
      ...
      var paymentInCurrentSection =
        JotForm.currentSection &&
        JotForm.currentSection.down('li[data-payment="true"]');
      ...
      if ((paymentInCurrentSection || noPage) && JotForm.browserIs.firefox()) {
        ...
        for (var i = 0; i < requiredProductInputs.length; i++) {
          if (
            (JotForm.isVisible(requiredProductInputs[i]) ||
              JotForm.clearFieldOnHide === "dontClear") &&
            !requiredProductInputs[i].checked
          ) {
  ...
  errored: function (input, message) {
          ...
          collapse
            ...
            .insert({
              top:
                ...
                preLink +
                'images/exclamation-octagon.png"> ',
            })
            .setStyle({ color: "red" });
        } else {
          collapse
    ...
    insertEl.insert(
      new Element("div", { className: "form-error-message", role: "alert" })
  ...
  removeNonselectedProducts: function (form) {
    ...
    if (JotForm.newPaymentUI) {
      nonSelectedProducts = form.querySelectorAll(
        ".form-product-item.new_ui:not(.p_selected)"
      );
    } else {
      nonSelectedProducts = form
        .querySelectorAll(".form-product-item")
        .filter(function (item) {
          return (
            item.querySelector(".form-product-input") &&
            !item.querySelector(".form-product-input").checked
          );
        });
    }
  ...
  validator: function () {
    ...
    $A(JotForm.forms).each(function (form) {
      ...
      var handleFormSubmit = function (e) {
          ...
          if (
            ...
            if (Object.keys(JotForm.validatedRequiredFieldIDs).length > 0) {
              JotForm.errorCatcherLog(
                {
                  validatedRequiredFieldIDs: JotForm.validatedRequiredFieldIDs,
                },
            ...
            form.insert(
              new Element("input", {
                ...
                "Invalid Value: " + typeof JotForm.validatedRequiredFieldIDs
              )
            );
          }
          if (Object.keys(JotForm.visitedPages).length > 0) {
            form.insert(
              new Element("input", {
                type: "hidden",
                name: "visitedPages",
              }).putValue(JSON.stringify(JotForm.visitedPages))
            );
          }
          $$(".form-radio-other,.form-checkbox-other").each(function (el) {
            if (!el.checked && JotForm.getOptionOtherInput(el)) {
        ...
        var blueSnapLimit =
          JotForm.payment === "bluesnap" && numberOfInputs > 1000;
        if (numberOfInputs > 3000 || blueSnapLimit) {
        ...
        var signatureInputValues = document.querySelectorAll(
          '.signature-line input[type="hidden"]'
        );
        var signatureValuesArray = Array.from(signatureInputValues).map(
          function (signInputItem) {
            return { id: signInputItem.id, value: signInputItem.value };
          }
        );
        history.pushState(
          { signatureValues: signatureValuesArray },
          null,
          null
        );
        ...
        history.replaceState(
          Object.assign({}, history.state, { submitted: true }),
          null,
          null
        );
      };
      ...
      submitEventRegistry.forEach(function (event) {
        if (event.handler.name === "handleFormSubmit")
          submitEventMounted = true;
      });
        ...
        try {
          ...
          upload.validateInput = function () {
            ...
            if (exVal() !== false) {
              ...
              if (
                (accept.include(ext) || accept.include(ext.toLowerCase())) &&
                validateImage &&
      ...
      return $A(document.querySelectorAll(selector)).map(function (e) {
        ...
        if (_isVisible) {
          if (e.name === "") {
            ...
            if (
              JotForm.categoryConnectedProducts !== undefined &&
              JotForm.categoryConnectedProducts[productID] !== undefined
            ) {
              Array.from(JotForm.categoryConnectedProducts[productID]).forEach(
                function (pid) {
                  var productCheckbox = $$(
  ...
  setFieldValidation: function (input) {
    ...
    input.validateInput = function (deep, dontShowMessage) {
      ...
      if (
        ...
        if (
          Array.from(validatedFitbInputs)
            .map(function (subInput) {
              return subInput.validateInput
                ? subInput.validateInput(true)
      ...
      if (
        ...
        !(input.id.match(/_quantity_/) || input.id.match(/_custom_/)) &&
        !(
          JotForm.getContainer(input).getAttribute("data-type") ===
          "control_inline"
        )
      ...
      if (vals.include("required")) {
        ...
        if (input.tagName == "INPUT" && input.readAttribute("type") == "file") {
          ...
          try {
            ...
            var checkValues = inputs.map(function (e) {
              ...
              if (e.id.match(/input_[0-9]+_quantity_[0-9]+_[0-9]+/)) {
                ...
                if (
                  (cb.checked &&
                    !subProductQty &&
                    (isNaN(e.value) || e.value == 0 || e.value.empty())) ||
                  !allProducts
                    .map(function (c) {
                      return c.checked;
                    })
              ...
              if (innerVals.include("required") && _isVisible) {
                if (
                  ...
                  if (inputType === "checkbox") {
                    ...
                    var TIMESTAMP_OF_2019 = 1546300000000;
                    var isNewIDType =
                      isNaN(fieldId) || Number(fieldId) < TIMESTAMP_OF_2019;
            ...
            if (
              ...
              JotForm.isEditMode() &&
              (cont.getAttribute("data-type").match(JotForm.payment) ||
                (JotForm.payment === "paypalcomplete" &&
                  cont.getAttribute("data-type") === "control_paymentmethods"))
            ) {
              return JotForm.corrected(input);
            }
            if (checkValues.any()) {
        ...
        if (
          ...
          (!input.value ||
            ...
            (typeof textAreaEditorInput === "string" &&
      ...
      setTimeout(function () {
        try {
          ...
          if (
            ...
            !(
              window.FORM_MODE === "cardform" &&
              inputContainer.dataset.type === "control_yesno"
            ) &&
            !(
              window.FORM_MODE === "cardform" &&
  ...
  bringOldFBSubmissionBack: function (id) {
    ...
    if (formIDField && formIDField.value) {
      var a = new Ajax.Jsonp(
        ...
        {
          parameters: { formID: formIDField.value, fbid: id },
          evalJSON: "force",
          onComplete: function (t) {
            var res = t.responseJSON;
            if (res.success) {
  ...
  getOptionOtherInput: function (option) {
    if (
      !option ||
      !option.classList.contains("form-" + option.type + "-other")
    ) {
      return null;
    }
    ...
    if (form.name === "form_" + form.id) {
      ...
      if (jsExecutionTrackerElement) {
        ...
        jsExecutionTrackerElement.value +=
          "=>" + (value + indexString + ":" + new Date().getTime());
      } else {
        appendHiddenInput(
          "jsExecutionTracker",
...
function addEncryptionKeyToForm(encryptionKey) {
  var encryptionKeyInput = document.querySelector(
    'input[name="submissionEncryptionKey"]'
  );
...
Calendar._checkCalendar = function (event) {
  ...
  if (
    Element.descendantOf(Event.element(event), window._popupCalendar.container)
  ) {
    return;
  }
  if (
...
Calendar.hermesDateListPopups = function (event) {
  ...
  var popupType = event.target.hasClassName("select-month")
    ? "months"
    : "years";
  if (
    popup.hasClassName("active") &&
    popup.getAttribute("popup-type") === popupType
  ) {
...
function handlePopupUI(calendar, style) {
  ...
  if (title && nextYear && nextMonth && prevYear && prevMonth) {
    ...
    newHeader.innerHTML =
      '<div class="calendar-new-month"><span>' +
      month +
      '</span></div><div class="calendar-new-year">' +
      year +
      "</div>";
...
Calendar.prototype = {
  ...
  setDynamicLimits: function () {
    var getComparativeDate = function (dat) {
      var todayKey =
        dat.indexOf("today") > -1
          ? /today/
          : new RegExp(Calendar.TODAY.trim(), "i");
      if (todayKey.test(dat)) {
        ...
        var getUnselectedDaysCount = function () {
          ...
          while (curDate <= comp) {
            var dayName = curDate
              ...
              .toLowerCase();
            if (
              lim.days[dayName] !== undefined &&
              lim.days[dayName] === false
            ) {
              unselectedDaysCount++;
            }
        ...
        return (
          comp.getFullYear() +
          "-" +
          JotForm.addZeros(comp.getMonth() + 1, 2) +
          "-" +
          JotForm.addZeros(comp.getDate(), 2)
        );
      } else {
        return dat;
      }
  ...
  update: function (date) {
    ...
    Element.getElementsBySelector(this.container, "tbody tr").each(function (
      row,
      i
    ) {
        ...
        if (calendar.limits) {
          ...
          if (
            ...
            for (var j = 0; j < lim.custom.length; j++) {
              ...
              if (
                lim.custom[j] === date.getFullYear() + "-" + m + "-" + d ||
                (typeof lim.custom[j] == "string" &&
                  lim.custom[j].length === 5 &&
                  lim.custom[j] === m + "-" + d) ||
                (typeof lim.custom[j] == "string" &&
    ...
    if (
      !JotForm.isSourceTeam &&
      !JotForm.isMarvelTeam &&
      !JotForm.isHermesTeam
    ) {
      this.container
  ...
  setNames: function (id) {
    Calendar.DAY_NAMES =
      ...
      Calendar.DAY_NAMES;
    for (var i = 0; i <= 7; i++) {
      Calendar.SHORT_DAY_NAMES[i] = Calendar.DAY_NAMES[
        i % Calendar.DAY_NAMES.length
      ]
        .substring(0, 1)
        .toUpperCase();
    }
  ...
  create: function (parent, id) {
    ...
    if (JotForm.isSourceTeam) {
      ...
      if (checkLegacyForm && checkLegacyForm.length > 0) {
        this._drawButtonCell(
          row,
          '&#x00ab;<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-32 h-32"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg>',
          1,
          Calendar.NAV_PREVIOUS_YEAR,
          "previousYear"
        );
        ...
        this._drawButtonCell(
          row,
          '&#x203a;<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" class="w-32 h-32"><path fill-rule="evenodd" d="M11.293 7.293a1 1 0 0 1 1.414 0l7 7a1 1 0 0 1-1.414 1.414L12 9.414l-6.293 6.293a1 1 0 0 1-1.414-1.414l7-7Z" clip-rule="evenodd"></path></svg>',
          1,
          Calendar.NAV_NEXT_MONTH,
          "nextMonth"
        );
    ...
    if (JotForm.isHermesTeam) {
      ...
      for (
        var i = Calendar.prototype.maxYear;
        i >= Calendar.prototype.minYear;
        i--
      ) {
  ...
  for (i = 0; i < a.length; ++i) {
    ...
    switch (b[i]) {
      ...
      case "%B":
        for (j = 0; j < 12; ++j) {
          if (
            Calendar.MONTH_NAMES[j].substr(0, a[i].length).toLowerCase() ==
            a[i].toLowerCase()
          ) {
            m = j;
            break;
